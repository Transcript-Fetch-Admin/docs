...
Prefer raw HTTP? The API is plain HTTPS/JSON, see the [endpoint reference](https://transcriptfetch.com/docs/endpoints) for every route and the [response format](https://transcriptfetch.com/docs/output).
